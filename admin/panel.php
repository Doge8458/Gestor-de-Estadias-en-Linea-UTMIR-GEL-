...
<body>
    ...
    <script src="https://npmcdn.com/flatpickr/dist/l10n/es.js"></script>
        ...
        window.adminPanelData = {
            fechaInicio: <?php echo json_encode(isset($periodo_actual['fecha_inicio']) ? $periodo_actual['fecha_inicio'] : ''); ?>,
            fechaFin: <?php echo json_encode(isset($periodo_actual['fecha_fin']) ? $periodo_actual['fecha_fin'] : ''); ?>
        };
    </script>
